...
const VALID_WORDS = new Set([
    ...
    'dads', 'dams', 'days', 'dens', 'dies', 'digs', 'dips', 'dogs', 'dots', 'dubs', 'duds', 'dues', 'dugs', 'dyes',
    'ears', 'eats', 'eels', 'eggs', 'egos', 'elms', 'ends', 'eras', 'eves', 'eyes',
    'fads', 'fans', 'fats', 'fees', 'figs', 'fins', 'firs', 'fits', 'foes', 'fogs', 'fries', 'funs', 'furs',
    'gags', 'gaps', 'gels', 'gems', 'gets', 'gins', 'gods', 'gums', 'guns', 'guts', 'guys', 'gyms',
    'hams', 'hats', 'hems', 'hens', 'hips', 'hits', 'hobs', 'hogs', 'hops', 'hubs', 'hues', 'hugs', 'hums', 'huts',
    'ices', 'ills', 'imps', 'inks', 'inns', 'ions', 'ires', 'irks',
    'jabs', 'jags', 'jams', 'jars', 'jaws', 'jays', 'jets', 'jigs', 'jobs', 'jogs', 'jots', 'joys', 'jugs', 'juts',
    'kegs', 'keys', 'kids', 'kins', 'kits',
    'labs', 'lads', 'lags', 'laws', 'lays', 'leas', 'legs', 'lets', 'lids', 'lies', 'lips', 'logs', 'lots', 'lugs',
    'maps', 'mars', 'mats', 'maws', 'mobs', 'moms', 'mops', 'muds', 'mugs', 'mums',
    'nabs', 'nags', 'naps', 'nets', 'nips', 'nits', 'nods', 'nubs', 'nuns', 'nuts',
    'oars', 'oats', 'odes', 'oils', 'ones', 'opts', 'orbs', 'ores', 'owes', 'owns',
    'pads', 'pals', 'pans', 'pars', 'pats', 'paws', 'pays', 'pegs', 'pens', 'peps', 'pets', 'pews', 'pigs', 'pins', 'pits', 'pods', 'pops', 'pots', 'pros', 'pubs', 'pugs', 'puns', 'pups', 'puts',
    'rads', 'rags', 'rams', 'raps', 'rats', 'rays', 'reds', 'refs', 'reps', 'ribs', 'rids', 'rigs', 'rims', 'rips', 'robs', 'rods', 'roes', 'rots', 'rows', 'rubs', 'rugs', 'rums', 'ruts', 'ryes',
    'sacs', 'sags', 'saps', 'saws', 'says', 'seas', 'sets', 'sews', 'sins', 'sips', 'sirs', 'sits', 'skis', 'sobs', 'sods', 'sons', 'sops', 'sots', 'sows', 'soys', 'spas', 'subs', 'sums', 'suns', 'sups',
    'tabs', 'tads', 'tags', 'tans', 'tars', 'tats', 'tens', 'tics', 'ties', 'tins', 'toes', 'toms', 'tons', 'tops', 'tots', 'tows', 'toys', 'tubs', 'tugs', 'twos',
    'urns', 'uses',
    'vans', 'vats', 'vets', 'vies', 'vows',
    'wads', 'wags', 'wars', 'ways', 'webs', 'weds', 'wigs', 'wits', 'woes', 'woks', 'woos', 'wows',
    'yaks', 'yams', 'yaps', 'yaws', 'yeas', 'yens', 'yews', 'yows',
    'zags', 'zaps', 'zeds', 'zees', 'zens', 'zigs', 'zips', 'zits', 'zoos',
    // More common plurals
    'aches', 'acids', 'aides', 'areas', 'aunts', 'autos', 'backs', 'baits', 'bakes', 'balls', 'bands', 'banks', 'barks', 'barns', 'baths', 'beads', 'beaks', 'beams', 'beans', 'bears', 'beats', 'beefs', 'beers', 'bells', 'belts', 'bends', 'biles', 'bills', 'binds', 'birds', 'bites', 'blobs', 'blows', 'blurs', 'boars', 'boats', 'boils', 'bolts', 'bombs', 'bonds', 'bones', 'books', 'booms', 'boots', 'bores', 'bouts', 'bowls', 'brews', 'brims', 'bucks', 'bulbs', 'bulks', 'bulls', 'bumps', 'burns', 'bushs', 'busts', 'cafes', 'cages', 'calfs', 'calls', 'calms', 'camps', 'capes', 'cards', 'cares', 'carts', 'cases', 'caves', 'cells', 'chats', 'chefs', 'chews', 'chins', 'chips', 'chops', 'clads', 'clams', 'clans', 'claps', 'claws', 'clays', 'clips', 'clubs', 'clues', 'coals', 'coats', 'codes', 'coils', 'coins', 'colds', 'comes', 'cones', 'cooks', 'cools', 'copes', 'cords', 'cores', 'corks', 'corns', 'costs', 'crabs', 'crews', 'cribs', 'crops', 'crows', 'cubes', 'cures', 'curls', 'dames', 'damps', 'dares', 'darks', 'darts', 'dates', 'dawns', 'deads', 'deals', 'deans', 'debts', 'decks', 'deeds', 'deems', 'deeps', 'deers', 'demos', 'dents', 'desks', 'dials', 'dices', 'diets', 'dimes', 'dines', 'dirts', 'disks', 'dives', 'docks', 'dolls', 'domes', 'dooms', 'doors', 'doses', 'downs', 'drags', 'drams', 'draws', 'drips', 'drops', 'drums', 'ducks', 'dudes', 'duels', 'dukes', 'dulls', 'dumbs', 'dumps', 'dunes', 'dunks', 'dusks', 'dusts',
    'earns', 'eases', 'echos', 'edges', 'emits', 'epics', 'evens', 'evils', 'exams', 'exits',
    'faces', 'facts', 'fades', 'fails', 'fairs', 'fakes', 'falls', 'fames', 'fangs', 'fares', 'farms', 'fasts', 'fates', 'fawns', 'fears', 'feats', 'feeds', 'feels', 'fells', 'felts', 'ferns', 'fests', 'files', 'fills', 'films', 'finds', 'fines', 'fires', 'firms', 'fishs', 'fists', 'fives', 'flags', 'flaks', 'flats', 'flaws', 'fleas', 'flews', 'flips', 'flits', 'flows', 'foams', 'foils', 'folds', 'folks', 'fonds', 'fonts', 'foods', 'fools', 'foots', 'forks', 'forms', 'forts', 'fouls', 'fours', 'frogs', 'fuels', 'fulls', 'fumes', 'funds', 'fuses',
    'gains', 'gales', 'games', 'gangs', 'gates', 'gazes', 'gears', 'genes', 'gifts', 'girls', 'gives', 'glads', 'glens', 'glows', 'glues', 'glums', 'goats', 'golds', 'golfs', 'gowns', 'grabs', 'grams', 'grays', 'grids', 'grims', 'grins', 'grips', 'grits', 'grows', 'gulfs', 'gurus', 'gusts',
    'hacks', 'hails', 'hairs', 'halfs', 'halls', 'halts', 'hands', 'hangs', 'hards', 'hares', 'harms', 'harps', 'hashs', 'hates', 'hauls', 'hawks', 'hazes', 'heads', 'heals', 'heaps', 'hears', 'heats', 'heels', 'hells', 'helms', 'helps', 'hemps', 'herbs', 'herds', 'heros', 'hides', 'highs', 'hikes', 'hints', 'hires', 'holds', 'holes', 'homes', 'hoods', 'hoops', 'hopes', 'horns', 'hosts', 'hours', 'hulks', 'hulls', 'humps', 'hunts', 'hurts',
    'icons', 'ideas', 'idols', 'infos', 'irons', 'isles', 'items',
    'jacks', 'jades', 'jails', 'jerks', 'jests', 'joins', 'jokes', 'jumps', 'junks',
    'keeps', 'kelps', 'kicks', 'kills', 'kinds', 'kings', 'kites', 'knees', 'knits', 'knobs', 'knots', 'knows',
    'laces', 'lacks', 'lakes', 'lambs', 'lamps', 'lands', 'larks', 'lasts', 'lates', 'lawns', 'leads', 'leafs', 'leaks', 'leans', 'leaps', 'lefts', 'lends', 'licks', 'lifts', 'likes', 'limbs', 'limes', 'limps', 'lines', 'links', 'lints', 'lions', 'lists', 'lives', 'loads', 'loafs', 'locks', 'lofts', 'logos', 'longs', 'looks', 'loops', 'lords', 'lores', 'loves', 'lucks', 'lumps', 'lungs', 'lures', 'lurks', 'lusts',
    'maids', 'mails', 'mains', 'makes', 'males', 'malls', 'malts', 'marks', 'mashs', 'masks', 'masts', 'mates', 'maths', 'mazes', 'meals', 'means', 'meats', 'meets', 'melts', 'memos', 'menus', 'meres', 'meshs', 'miles', 'milks', 'mills', 'minds', 'mines', 'mints', 'mists', 'modes', 'molds', 'moles', 'monks', 'moods', 'moons', 'mores', 'moths', 'moves', 'mules', 'murks', 'muses', 'mushs', 'musts', 'mutes', 'myths',
    'nails', 'names', 'nears', 'neats', 'necks', 'neons', 'nests', 'nicks', 'nines', 'nodes', 'noons', 'norms', 'noses', 'notes', 'nouns', 'nudes',
    'oaths', 'obeys', 'odors', 'omens', 'opens', 'oozes', 'orcas', 'ovens', 'overs',
    'paces', 'packs', 'pages', 'pails', 'pains', 'pairs', 'pales', 'palms', 'panes', 'pants', 'parks', 'parts', 'paths', 'paves', 'peaks', 'pecks', 'peels', 'peers', 'pelts', 'perks', 'perms', 'pests', 'picks', 'piers', 'pikes', 'piles', 'pills', 'pines', 'pinks', 'pints', 'pipes', 'pitas', 'plans', 'plays', 'pleas', 'plods', 'plops', 'plots', 'plows', 'ploys', 'plugs', 'plums', 'poems', 'poets', 'pokes', 'poles', 'polls', 'polos', 'ponds', 'pools', 'poors', 'pores', 'porks', 'ports', 'poses', 'posts', 'pours', 'pouts', 'prays', 'preps', 'preys', 'prims', 'prods', 'props', 'puffs', 'pulls', 'pulps', 'pumps', 'punks', 'pures', 'pushs',
    'quits',
    'races', 'rafts', 'rages', 'raids', 'rails', 'rains', 'rakes', 'ramps', 'ranks', 'rants', 'rares', 'rashs', 'rates', 'raves', 'reads', 'reals', 'reams', 'reaps', 'rears', 'reefs', 'reels', 'rents', 'rests', 'rides', 'rifts', 'rinds', 'rings', 'riots', 'rises', 'risks', 'rites', 'roads', 'roams', 'roars', 'robes', 'rocks', 'roles', 'roofs', 'rooms', 'roots', 'ropes', 'roses', 'routs', 'ruins', 'rules', 'rumps', 'rungs', 'runts', 'rushs', 'rusts',
    'sacks', 'safes', 'sages', 'sails', 'sakes', 'sales', 'salts', 'sands', 'sanes', 'sangs', 'sanks', 'saves', 'seals', 'seams', 'seeds', 'seeks', 'seems', 'seeps', 'sells', 'semis', 'sends', 'sheds', 'ships', 'shops', 'shots', 'shows', 'shuts', 'sicks', 'sides', 'sifts', 'sighs', 'signs', 'silks', 'sings', 'sinks', 'sites', 'sizes', 'skins', 'skips', 'slabs', 'slams', 'slaps', 'slats', 'slaws', 'sleds', 'slews', 'slids', 'slims', 'slips', 'slits', 'slobs', 'slops', 'slots', 'slows', 'slugs', 'slums', 'snaps', 'snips', 'snobs', 'snows', 'snubs', 'snugs', 'soaks', 'soaps', 'soars', 'socks', 'sodas', 'sofas', 'softs', 'soils', 'solds', 'soles', 'songs', 'soots', 'sores', 'sorts', 'souls', 'soups', 'sours', 'spans', 'spars', 'spats', 'specs', 'speds', 'spins', 'spits', 'spots', 'spuns', 'spurs', 'stabs', 'stags', 'stars', 'stays', 'stems', 'steps', 'stews', 'stirs', 'stops', 'stubs', 'studs', 'stuns', 'sucks', 'suits', 'sulks', 'sungs', 'sunks', 'surfs', 'swams', 'swans', 'swaps', 'sways', 'swims', 'swums',
    'tacks', 'tacos', 'tails', 'takes', 'tales', 'talks', 'talls', 'tames', 'tanks', 'tapes', 'tasks', 'taxis', 'teaks', 'teams', 'teens', 'tells', 'temps', 'tends', 'tents', 'terms', 'tests', 'texts', 'thaws', 'thuds', 'ticks', 'tides', 'tiers', 'tiles', 'tilts', 'times', 'tints', 'tires', 'toads', 'toils', 'tolls', 'tombs', 'tones', 'tools', 'tores', 'torns', 'totes', 'tours', 'towns', 'traps', 'trays', 'trees', 'treks', 'trims', 'trios', 'trips', 'trods', 'trots', 'trues', 'tubes', 'tucks', 'tufts', 'tunas', 'tunes', 'turfs', 'turns', 'tusks', 'twins', 'twits', 'types',
    'undos', 'units', 'urges', 'users',
    'vains', 'vales', 'vanes', 'vases', 'vasts', 'veals', 'veers', 'vents', 'verbs', 'vests', 'vetos', 'vibes', 'vices', 'views', 'viles', 'vines', 'visas', 'voids', 'volts', 'votes',
    'wades', 'wages', 'wails', 'waits', 'wakes', 'walks', 'walls', 'wands', 'wants', 'wards', 'warms', 'warns', 'warps', 'warts', 'washs', 'wasps', 'waves', 'weaks', 'wears', 'weeds', 'weeks', 'weeps', 'welds', 'wells', 'wents', 'wests', 'whats', 'whens', 'whims', 'whips', 'whirs', 'wicks', 'wides', 'wifes', 'wilds', 'wills', 'wilts', 'wimps', 'winds', 'wines', 'wings', 'winks', 'wipes', 'wires', 'wishs', 'wolfs', 'wombs', 'woods', 'woofs', 'wools', 'words', 'works', 'worms', 'worns', 'wraps', 'wrens',
    'yanks', 'yards', 'yarns', 'yawns', 'years', 'yells', 'yelps', 'yogas', 'yokes', 'yolks', 'yucks',
    'zeals', 'zeros', 'zests', 'zincs', 'zones', 'zooms'
]);
...
async function submitWord() {
    ...
    if (foundWords.includes(word)) {
        showMessage('Already chosen!', 'error');
        clearWord();
        return;
    }
        ...
        if (res.ok) {
            ...
            if (data.result && data.result.details) {
                ...
                if (isDone) {
                    ...
                    doneSection.classList.add('done-submitted');
...
// Save progress
async function saveProgress(markAsDone = false) {
    try {
...
async function markDone() {
    ...
    document.getElementById('modal-message').textContent = `You found ${foundWords.length} words for ${score} points!`;
    document.getElementById('game-modal').classList.add('show');
}

// Event listeners
document.getElementById('del-btn').addEventListener('click', deleteLetter);
